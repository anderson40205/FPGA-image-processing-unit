...
architecture behav of canny_edge_detection is 
    ...
    "canny_edge_detection,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.648000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.648000,HLS_SYN_LAT=276999,HLS_SYN_TPT=276994,HLS_SYN_MEM=6,HLS_SYN_DSP=5,HLS_SYN_FF=4279,HLS_SYN_LUT=5883,HLS_VERSION=2019_1}";
    ...
    signal AXIS2GrayArray66_U0_ap_start : STD_LOGIC;
    signal AXIS2GrayArray66_U0_start_full_n : STD_LOGIC;
    signal AXIS2GrayArray66_U0_ap_done : STD_LOGIC;
    signal AXIS2GrayArray66_U0_ap_continue : STD_LOGIC;
    signal AXIS2GrayArray66_U0_ap_idle : STD_LOGIC;
    signal AXIS2GrayArray66_U0_ap_ready : STD_LOGIC;
    signal AXIS2GrayArray66_U0_start_out : STD_LOGIC;
    signal AXIS2GrayArray66_U0_start_write : STD_LOGIC;
    signal AXIS2GrayArray66_U0_axis_in_TREADY : STD_LOGIC;
    signal AXIS2GrayArray66_U0_hist_hthr_read : STD_LOGIC;
    signal AXIS2GrayArray66_U0_hist_lthr_read : STD_LOGIC;
    signal AXIS2GrayArray66_U0_hist_hthr_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIS2GrayArray66_U0_hist_hthr_out_write : STD_LOGIC;
    signal AXIS2GrayArray66_U0_hist_lthr_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIS2GrayArray66_U0_hist_lthr_out_write : STD_LOGIC;
    signal AXIS2GrayArray66_U0_fifo1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIS2GrayArray66_U0_fifo1_write : STD_LOGIC;
    ...
    signal ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_canny_edge_detection_1_1_U0_ap_ready : STD_LOGIC;
    signal canny_edge_detection_1_1_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal ap_sync_reg_AXIS2GrayArray66_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_AXIS2GrayArray66_U0_ap_ready : STD_LOGIC;
    signal AXIS2GrayArray66_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component canny_edge_detection_AXILiteS_s_axi IS
    generic (
...
begin
    canny_edge_detection_AXILiteS_s_axi_U : component canny_edge_detection_AXILiteS_s_axi
    generic map (
    ...
    AXIS2GrayArray66_U0 : component AXIS2GrayArray66
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => AXIS2GrayArray66_U0_ap_start,
        start_full_n => AXIS2GrayArray66_U0_start_full_n,
        ap_done => AXIS2GrayArray66_U0_ap_done,
        ap_continue => AXIS2GrayArray66_U0_ap_continue,
        ap_idle => AXIS2GrayArray66_U0_ap_idle,
        ap_ready => AXIS2GrayArray66_U0_ap_ready,
        start_out => AXIS2GrayArray66_U0_start_out,
        start_write => AXIS2GrayArray66_U0_start_write,
        axis_in_TDATA => axis_in_TDATA,
        axis_in_TVALID => axis_in_TVALID,
        axis_in_TREADY => AXIS2GrayArray66_U0_axis_in_TREADY,
        hist_hthr_dout => hist_hthr_c1_dout,
        hist_hthr_empty_n => hist_hthr_c1_empty_n,
        hist_hthr_read => AXIS2GrayArray66_U0_hist_hthr_read,
        hist_lthr_dout => hist_lthr_c2_dout,
        hist_lthr_empty_n => hist_lthr_c2_empty_n,
        hist_lthr_read => AXIS2GrayArray66_U0_hist_lthr_read,
        hist_hthr_out_din => AXIS2GrayArray66_U0_hist_hthr_out_din,
        hist_hthr_out_full_n => hist_hthr_c_full_n,
        hist_hthr_out_write => AXIS2GrayArray66_U0_hist_hthr_out_write,
        hist_lthr_out_din => AXIS2GrayArray66_U0_hist_lthr_out_din,
        hist_lthr_out_full_n => hist_lthr_c_full_n,
        hist_lthr_out_write => AXIS2GrayArray66_U0_hist_lthr_out_write,
        fifo1_din => AXIS2GrayArray66_U0_fifo1_din,
        fifo1_full_n => fifo1_full_n,
        fifo1_write => AXIS2GrayArray66_U0_fifo1_write);
    ...
    port map (
        ...
        hthr_dout => hist_hthr_c_dout,
        hthr_empty_n => hist_hthr_c_empty_n,
        hthr_read => HystThreshold_U0_hthr_read,
        lthr_dout => hist_lthr_c_dout,
        lthr_empty_n => hist_lthr_c_empty_n,
    ...
    port map (
        ...
        if_read => AXIS2GrayArray66_U0_hist_hthr_read);
    ...
    port map (
        ...
        if_read => AXIS2GrayArray66_U0_hist_lthr_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIS2GrayArray66_U0_hist_hthr_out_din,
        if_full_n => hist_hthr_c_full_n,
        if_write => AXIS2GrayArray66_U0_hist_hthr_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIS2GrayArray66_U0_hist_lthr_out_din,
        if_full_n => hist_lthr_c_full_n,
        if_write => AXIS2GrayArray66_U0_hist_lthr_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIS2GrayArray66_U0_fifo1_din,
        if_full_n => fifo1_full_n,
        if_write => AXIS2GrayArray66_U0_fifo1_write,
        if_dout => fifo1_dout,
    ...
    port map (
        ...
        if_write => AXIS2GrayArray66_U0_start_write,
    ...
    ap_sync_reg_AXIS2GrayArray66_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_AXIS2GrayArray66_U0_ap_ready <= ap_sync_AXIS2GrayArray66_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready <= ap_sync_canny_edge_detection_1_1_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    AXIS2GrayArray66_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = AXIS2GrayArray66_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                AXIS2GrayArray66_U0_ap_ready_count <= std_logic_vector(unsigned(AXIS2GrayArray66_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = AXIS2GrayArray66_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                AXIS2GrayArray66_U0_ap_ready_count <= std_logic_vector(unsigned(AXIS2GrayArray66_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    canny_edge_detection_1_1_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((canny_edge_detection_1_1_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                canny_edge_detection_1_1_U0_ap_ready_count <= std_logic_vector(unsigned(canny_edge_detection_1_1_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((canny_edge_detection_1_1_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                canny_edge_detection_1_1_U0_ap_ready_count <= std_logic_vector(unsigned(canny_edge_detection_1_1_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    AXIS2GrayArray66_U0_ap_continue <= ap_const_logic_1;
    AXIS2GrayArray66_U0_ap_start <= ((ap_sync_reg_AXIS2GrayArray66_U0_ap_ready xor ap_const_logic_1) and ap_start);
    AXIS2GrayArray66_U0_start_full_n <= (start_for_HystThreshold_U0_full_n and start_for_GaussianBlur_U0_full_n);
    ...
    ap_done <= GrayArray2AXIS_U0_ap_done;
    ap_idle <= (canny_edge_detection_1_1_U0_ap_idle and ZeroPadding_U0_ap_idle and Sobel_512u_512u_U0_ap_idle and NonMaxSuppression_U0_ap_idle and HystThreshold_U0_ap_idle and HystThresholdComp_U0_ap_idle and GrayArray2AXIS_U0_ap_idle and GaussianBlur_U0_ap_idle and AXIS2GrayArray66_U0_ap_idle);
    ...
    ap_sync_AXIS2GrayArray66_U0_ap_ready <= (ap_sync_reg_AXIS2GrayArray66_U0_ap_ready or AXIS2GrayArray66_U0_ap_ready);
    ap_sync_canny_edge_detection_1_1_U0_ap_ready <= (canny_edge_detection_1_1_U0_ap_ready or ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= GrayArray2AXIS_U0_ap_done;
    ap_sync_ready <= (ap_sync_canny_edge_detection_1_1_U0_ap_ready and ap_sync_AXIS2GrayArray66_U0_ap_ready);
    axis_in_TREADY <= AXIS2GrayArray66_U0_axis_in_TREADY;
    axis_out_TDATA <= GrayArray2AXIS_U0_axis_out_TDATA;
    axis_out_TLAST <= GrayArray2AXIS_U0_axis_out_TLAST;
    axis_out_TVALID <= GrayArray2AXIS_U0_axis_out_TVALID;
    canny_edge_detection_1_1_U0_ap_continue <= ap_const_logic_1;
    canny_edge_detection_1_1_U0_ap_start <= ((ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready xor ap_const_logic_1) and ap_start);
