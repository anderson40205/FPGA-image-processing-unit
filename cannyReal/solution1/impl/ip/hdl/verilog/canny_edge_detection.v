...
wire    AXIS2GrayArray66_U0_ap_start;
wire    AXIS2GrayArray66_U0_start_full_n;
wire    AXIS2GrayArray66_U0_ap_done;
wire    AXIS2GrayArray66_U0_ap_continue;
wire    AXIS2GrayArray66_U0_ap_idle;
wire    AXIS2GrayArray66_U0_ap_ready;
wire    AXIS2GrayArray66_U0_start_out;
wire    AXIS2GrayArray66_U0_start_write;
wire    AXIS2GrayArray66_U0_axis_in_TREADY;
wire    AXIS2GrayArray66_U0_hist_hthr_read;
wire    AXIS2GrayArray66_U0_hist_lthr_read;
wire   [7:0] AXIS2GrayArray66_U0_hist_hthr_out_din;
wire    AXIS2GrayArray66_U0_hist_hthr_out_write;
wire   [7:0] AXIS2GrayArray66_U0_hist_lthr_out_din;
wire    AXIS2GrayArray66_U0_hist_lthr_out_write;
wire   [7:0] AXIS2GrayArray66_U0_fifo1_din;
wire    AXIS2GrayArray66_U0_fifo1_write;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready;
wire    ap_sync_canny_edge_detection_1_1_U0_ap_ready;
reg   [1:0] canny_edge_detection_1_1_U0_ap_ready_count;
reg    ap_sync_reg_AXIS2GrayArray66_U0_ap_ready;
wire    ap_sync_AXIS2GrayArray66_U0_ap_ready;
reg   [1:0] AXIS2GrayArray66_U0_ap_ready_count;
...
initial begin
#0 ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready = 1'b0;
#0 canny_edge_detection_1_1_U0_ap_ready_count = 2'd0;
#0 ap_sync_reg_AXIS2GrayArray66_U0_ap_ready = 1'b0;
#0 AXIS2GrayArray66_U0_ap_ready_count = 2'd0;
end

canny_edge_detection_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
canny_edge_detection_AXILiteS_s_axi_U(
...
AXIS2GrayArray66 AXIS2GrayArray66_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_AXIS2GrayArray66_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == AXIS2GrayArray66_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        AXIS2GrayArray66_U0_ap_ready_count <= (AXIS2GrayArray66_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == AXIS2GrayArray66_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        AXIS2GrayArray66_U0_ap_ready_count <= (AXIS2GrayArray66_U0_ap_ready_count + 2'd1);
    end
end

always @ (posedge ap_clk) begin
    if (((canny_edge_detection_1_1_U0_ap_ready == 1'b0) & (ap_sync_ready == 1'b1))) begin
        canny_edge_detection_1_1_U0_ap_ready_count <= (canny_edge_detection_1_1_U0_ap_ready_count - 2'd1);
    end else if (((canny_edge_detection_1_1_U0_ap_ready == 1'b1) & (ap_sync_ready == 1'b0))) begin
        canny_edge_detection_1_1_U0_ap_ready_count <= (canny_edge_detection_1_1_U0_ap_ready_count + 2'd1);
    end
end

assign AXIS2GrayArray66_U0_ap_continue = 1'b1;

assign AXIS2GrayArray66_U0_ap_start = ((ap_sync_reg_AXIS2GrayArray66_U0_ap_ready ^ 1'b1) & ap_start);

assign AXIS2GrayArray66_U0_start_full_n = (start_for_HystThreshold_U0_full_n & start_for_GaussianBlur_U0_full_n);
...
assign ap_done = GrayArray2AXIS_U0_ap_done;

assign ap_idle = (canny_edge_detection_1_1_U0_ap_idle & ZeroPadding_U0_ap_idle & Sobel_512u_512u_U0_ap_idle & NonMaxSuppression_U0_ap_idle & HystThreshold_U0_ap_idle & HystThresholdComp_U0_ap_idle & GrayArray2AXIS_U0_ap_idle & GaussianBlur_U0_ap_idle & AXIS2GrayArray66_U0_ap_idle);
...
assign ap_sync_AXIS2GrayArray66_U0_ap_ready = (ap_sync_reg_AXIS2GrayArray66_U0_ap_ready | AXIS2GrayArray66_U0_ap_ready);

assign ap_sync_canny_edge_detection_1_1_U0_ap_ready = (canny_edge_detection_1_1_U0_ap_ready | ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready);

assign ap_sync_continue = 1'b1;

assign ap_sync_done = GrayArray2AXIS_U0_ap_done;

assign ap_sync_ready = (ap_sync_canny_edge_detection_1_1_U0_ap_ready & ap_sync_AXIS2GrayArray66_U0_ap_ready);

assign axis_in_TREADY = AXIS2GrayArray66_U0_axis_in_TREADY;
...
assign canny_edge_detection_1_1_U0_ap_start = ((ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready ^ 1'b1) & ap_start);
