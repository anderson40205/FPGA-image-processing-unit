...
#include "canny_edge_detection_AXILiteS_s_axi.h"
...
struct canny_edge_detection : public sc_module {
    ...
    canny_edge_detection_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>* canny_edge_detection_AXILiteS_s_axi_U;
    ...
    sc_signal< sc_logic > AXIS2GrayArray66_U0_ap_start;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_start_full_n;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_ap_done;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_ap_continue;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_ap_idle;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_ap_ready;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_start_out;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_start_write;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_axis_in_TREADY;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_hist_hthr_read;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_hist_lthr_read;
    sc_signal< sc_lv<8> > AXIS2GrayArray66_U0_hist_hthr_out_din;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_hist_hthr_out_write;
    sc_signal< sc_lv<8> > AXIS2GrayArray66_U0_hist_lthr_out_din;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_hist_lthr_out_write;
    sc_signal< sc_lv<8> > AXIS2GrayArray66_U0_fifo1_din;
    sc_signal< sc_logic > AXIS2GrayArray66_U0_fifo1_write;
    ...
    sc_signal< sc_logic > ap_sync_reg_canny_edge_detection_1_1_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_canny_edge_detection_1_1_U0_ap_ready;
    sc_signal< sc_lv<2> > canny_edge_detection_1_1_U0_ap_ready_count;
    sc_signal< sc_logic > ap_sync_reg_AXIS2GrayArray66_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_AXIS2GrayArray66_U0_ap_ready;
    sc_signal< sc_lv<2> > AXIS2GrayArray66_U0_ap_ready_count;
    ...
    void thread_AXIS2GrayArray66_U0_ap_continue();
    void thread_AXIS2GrayArray66_U0_ap_start();
    void thread_AXIS2GrayArray66_U0_start_full_n();
    ...
    void thread_ap_sync_AXIS2GrayArray66_U0_ap_ready();
    void thread_ap_sync_canny_edge_detection_1_1_U0_ap_ready();
