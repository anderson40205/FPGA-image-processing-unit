...
reg   [0:0] icmp_ln119_reg_172;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln119_reg_172_pp0_iter1_reg;
reg    fifo7_blk_n;
reg   [10:0] xi_0_i_reg_95;
wire   [0:0] icmp_ln118_fu_106_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [10:0] yi_fu_112_p2;
reg   [10:0] yi_reg_162;
wire   [0:0] icmp_ln125_fu_118_p2;
reg   [0:0] icmp_ln125_reg_167;
wire   [0:0] icmp_ln119_fu_124_p2;
...
wire   [10:0] xi_fu_130_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] and_ln125_fu_142_p2;
reg   [0:0] and_ln125_reg_181;
wire   [23:0] or_ln_i_fu_147_p4;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [10:0] yi_0_i_reg_84;
reg    ap_block_state1;
wire    ap_CS_fsm_state6;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] icmp_ln125_1_fu_136_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((axis_dst_last_V_1_state == 2'd1) | (axis_dst_data_V_1_state == 2'd1) | ((axis_dst_data_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0)) | ((axis_dst_last_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0))) & (icmp_ln118_fu_106_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((axis_dst_last_V_1_state == 2'd1) | (axis_dst_data_V_1_state == 2'd1) | ((axis_dst_data_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0)) | ((axis_dst_last_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0))) & (icmp_ln118_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~((axis_dst_last_V_1_state == 2'd1) | (axis_dst_data_V_1_state == 2'd1) | ((axis_dst_data_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0)) | ((axis_dst_last_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0))) & (icmp_ln118_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        xi_0_i_reg_95 <= 11'd0;
    end else if (((icmp_ln119_fu_124_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln119_fu_124_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln119_fu_124_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((axis_dst_last_V_1_state == 2'd1) | (axis_dst_data_V_1_state == 2'd1) | ((axis_dst_data_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0)) | ((axis_dst_last_V_1_state == 2'd3) & (axis_out_TREADY == 1'b0))) & (icmp_ln118_fu_106_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln119_reg_172 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln119_reg_172_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((icmp_ln119_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln119_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln119_fu_124_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln119_fu_124_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign and_ln125_fu_142_p2 = (icmp_ln125_reg_167 & icmp_ln125_1_fu_136_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln119_reg_172 == 1'd0) & (fifo7_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln119_reg_172 == 1'd0) & (fifo7_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln119_reg_172 == 1'd0) & (fifo7_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln119_reg_172 == 1'd0) & (axis_dst_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln119_reg_172 == 1'd0) & (fifo7_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln119_reg_172_pp0_iter1_reg == 1'd0) & (axis_dst_data_V_1_ack_in == 1'b0));
end
...
assign icmp_ln118_fu_106_p2 = ((yi_0_i_reg_84 == 11'd1080) ? 1'b1 : 1'b0);

assign icmp_ln119_fu_124_p2 = ((xi_0_i_reg_95 == 11'd1920) ? 1'b1 : 1'b0);

assign icmp_ln125_1_fu_136_p2 = ((xi_0_i_reg_95 == 11'd1919) ? 1'b1 : 1'b0);

assign icmp_ln125_fu_118_p2 = ((yi_0_i_reg_84 == 11'd1079) ? 1'b1 : 1'b0);

assign or_ln_i_fu_147_p4 = {{{fifo7_dout}, {fifo7_dout}}, {fifo7_dout}};

assign xi_fu_130_p2 = (xi_0_i_reg_95 + 11'd1);

assign yi_fu_112_p2 = (yi_0_i_reg_84 + 11'd1);
