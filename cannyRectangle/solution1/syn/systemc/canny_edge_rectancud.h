...
// ==============================================================
#ifndef __canny_edge_rectancud__HH__
#define __canny_edge_rectancud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_rectancud) {
    ...
    SC_CTOR(canny_edge_rectancud):  simcore_mac_0_U ("simcore_mac_0_U") {
