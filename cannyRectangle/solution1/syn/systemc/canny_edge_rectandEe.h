...
// ==============================================================
#ifndef __canny_edge_rectandEe__HH__
#define __canny_edge_rectandEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_rectandEe) {
    ...
    SC_CTOR(canny_edge_rectandEe):  simcore_mac_1_U ("simcore_mac_1_U") {
