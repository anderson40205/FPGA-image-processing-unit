...
// ==============================================================
#ifndef __canny_edge_rectanjbC__HH__
#define __canny_edge_rectanjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_rectanjbC) {
    ...
    SC_CTOR(canny_edge_rectanjbC):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
