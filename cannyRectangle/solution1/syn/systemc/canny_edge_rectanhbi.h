...
// ==============================================================
#ifndef __canny_edge_rectanhbi__HH__
#define __canny_edge_rectanhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_rectanhbi) {
    ...
    SC_CTOR(canny_edge_rectanhbi):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
