...
set C_modelArgMapList {[ 
	{ "Name" : "fifo3_value", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "fifo3.value","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "fifo3_grad", "interface" : "fifo", "bitwidth" : 2, "direction" : "READONLY", "bitSlice":[{"low":0,"up":1,"cElement": [{"cName": "fifo3.grad","cData": "enum GradDir","bit_use": { "low": 0,"up": 1},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "fifo4", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "fifo4","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} ]}
