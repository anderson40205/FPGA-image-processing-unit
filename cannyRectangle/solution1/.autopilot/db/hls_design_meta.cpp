...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("axis_in_TLAST", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("axis_out_TDATA", 24, hls_out, 2, "axis", "out_data", 1),
	Port_Property("axis_out_TLAST", 1, hls_out, 3, "axis", "out_data", 1),
	Port_Property("bh", 8, hls_in, 6, "ap_none", "in_data", 1),
	Port_Property("bl", 8, hls_in, 7, "ap_none", "in_data", 1),
	Port_Property("axis_in_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("axis_in_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("axis_out_TVALID", 1, hls_out, 3, "axis", "out_vld", 1),
	Port_Property("axis_out_TREADY", 1, hls_in, 3, "axis", "out_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "canny_edge_rectangle";
