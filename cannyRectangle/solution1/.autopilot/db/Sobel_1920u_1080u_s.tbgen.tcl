set moduleName Sobel_1920u_1080u_s
set isTopModule 0
...
set C_modelName {Sobel<1920u, 1080u>}
...
set C_modelArgMapList {[ 
	{ "Name" : "fifo2", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "fifo2","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "fifo3_value", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "fifo3.value","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "fifo3_grad", "interface" : "fifo", "bitwidth" : 2, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":1,"cElement": [{"cName": "fifo3.grad","cData": "enum GradDir","bit_use": { "low": 0,"up": 1},"cArray": [{"low" : 0,"up" : 2073599,"step" : 1}]}]}], "extern" : 0} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.canny_edge_rectang8j_U26", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.canny_edge_rectanhbi_U27", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.canny_edge_rectanibs_U28", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.canny_edge_rectanjbC_U29", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.canny_edge_rectankbM_U30", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2103841", "Max" : "2103841"}
	, {"Name" : "Interval", "Min" : "2103841", "Max" : "2103841"}
]}
