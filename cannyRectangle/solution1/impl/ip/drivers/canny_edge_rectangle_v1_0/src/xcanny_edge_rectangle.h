...
// ==============================================================
#ifndef XCANNY_EDGE_RECTANGLE_H
#define XCANNY_EDGE_RECTANGLE_H
...
#include <stddef.h>
#endif
#include "xcanny_edge_rectangle_hw.h"
...
} XCanny_edge_rectangle_Config;
#endif

typedef struct {
    u32 Axilites_BaseAddress;
    u32 IsReady;
} XCanny_edge_rectangle;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XCanny_edge_rectangle_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XCanny_edge_rectangle_ReadReg(BaseAddress, RegOffset) \
