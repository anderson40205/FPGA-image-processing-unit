...
set Library     "hls"
set IPName      "canny_edge_rectangle"
set Version     "1.0"
set DisplayName "Canny_edge_rectangle"
set Revision    "2005262103"
...
set sdx_kernel_name "canny_edge_rectangle"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/Users/ASUS/AppData/Roaming/Xilinx/Vivado/cannyRectangle/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {canny_edge_rectanbkb
...
## Variables
set Top "canny_edge_rectangle"
set TopNoPrefix "canny_edge_rectangle"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 hist_hthr R 0x0 "Data signal of hist_hthr" {{0 8 hist_hthr R 0 "Bit 7 to 0 Data signal of hist_hthr"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 hist_hthr_ctrl R 0x0 "Control signal of hist_hthr" {{0 1 hist_hthr_ap_vld R 0 "Control signal hist_hthr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 hist_lthr R 0x0 "Data signal of hist_lthr" {{0 8 hist_lthr R 0 "Bit 7 to 0 Data signal of hist_lthr"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c hist_lthr_ctrl R 0x0 "Control signal of hist_lthr" {{0 1 hist_lthr_ap_vld R 0 "Control signal hist_lthr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 11 machine 64 combinational 0 latency 2103846 II x}
